...
namespace amadeus_integration_test
{
    public class SeatMapDisplayTest
    {
        ...
        public void Get_SeatMap()
        {
            ...
            //Assert.True(safeLocation[0].type == "seatmap");
        }
        ...
        public void Post_SeatMap()
        {
            ...
            SeatMap[] response = seatMap.postSeatMap(Params.with("getFlightOffersBody", body));

            Assert.True(response != null);
            //Assert.True(restriction[0].type == "flight-offer");
