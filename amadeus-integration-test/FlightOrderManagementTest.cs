...
namespace amadeus_integration_test
{
    public class FlightOrderManagementTest
    {
        ...
        public void Get_FlightOrderManagement()
        {
            ...
            FlightOrderCreateQuery response = amadeus.referenceData.booking.flightOrderManagement.getFlightOrderManagement(Params.with("flight-orderId", "eJzTd9cPsbR083cDAArgAkc%3D"));
        ...
        public void Post_FlightOrderManagement()
        {
            ...
            FlightOrderCreateQuery response = amadeus.referenceData.booking.flightOrderManagement.postFlightOrderManagement(body);
        ...
        {
            var amadeus = GetAmadeusBuild();
            FlightOrderCreateQuery[] response = amadeus.referenceData.booking.flightOrderManagement.deleteFlightOrderManagement(Params.with("flight-orderId", "eJzTd9cPsbR083cDAArgAkc%3D"));
